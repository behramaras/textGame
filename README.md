# Behram's Interactive Fiction Game
...
**View Site** → [Behram's Interactive Fiction Game](https://behramaras.github.io/textGame/)
...
`assets/js/textgame.js` was checked using:
- **JSHint** for code quality and error detection
